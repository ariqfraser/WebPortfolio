...
function HomePage() {
    ...
    useEffect(() => {
        const resetSocials = () => {
            const heroCoordsX = document.getElementById("heroButtonPos").offsetLeft;
            const heroCoordsY = document.getElementById("heroButtonPos").offsetTop + 10;
            console.log(heroCoordsX, heroCoordsY);
            document.getElementById("socialGithub").style.top = heroCoordsY + "px";
            document.getElementById("socialGithub").style.left = heroCoordsX + "px";
            document.getElementById("socialMail").style.top = heroCoordsY + "px";
            document.getElementById("socialMail").style.left = heroCoordsX+60 + "px";
            document.getElementById("socialLinkedIn").style.top = heroCoordsY + "px";
            document.getElementById("socialLinkedIn").style.left = heroCoordsX+130+ "px";
        ...
        const moveSocials = () => {
            ...
            document.getElementById("socialLinkedIn").style.filter = 'scale(0.5)';
        ...
        const scrollEffects = () => {
            if (window.pageYOffset >= 500) navLinks.classList.add('nav-hide')
            if (window.pageYOffset < 500) navLinks.classList.remove('nav-hide')
    ...
    return (
        <>
            ...
            <Section title="featured" title2="projects" >
                <Card title="Project Title" icons={['nodejs', 'express', 'react', 'firebase']}>
